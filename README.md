...
In addition to building the PC configuration SMT problem, you are asked to analyze the generated formula for redundant assertions.

1. Once you have generated the formula for the PC configuration problem from Task 1, you need to analyze it for redundant assertions.
...
2. Write a short explanation in the [explanation.txt](task-2/explanation.txt) file.
